...
Original file is located at
    https://colab.research.google.com/drive/1SqI0uDZmP9_v8BNlvQL7dWsrXudiHar3
"""
...
if auth_pass != ADMIN_PASSWORD:
    ...
    st.warning("閲覧するには正しいパスワードを左のメニューに入力してほしい")
    st.stop()
...
def load_data():
    ...
    try:
        ...
        df.columns = [
            'student_id', 'name', 'debt', 'shift', 'shopping', 'prep',
...
if st.button('確認する'):
    if not input_id:
        ...
        if not user_data.empty:
            ...
            # 総額
            total = RATES['BASE'] + shift_pay + shop_pay + prep_pay + debt_pay + role_pay
